...
const DPMotor = (props) => {
  ...
  const updatedPannaAdded = (doublePannaArray) => {
    let pannaArray = [];
    doublePannaArray.forEach((panna) => {
      let foundDigit = 0;
    ...
    console.log("pannaArray", pannaArray);
  ...
  function checkValidationAdd() {
    if (digit && amount) {
      setPopupArray([{ bet: digit, point: amount }]);
      isPopup(true);
    } else {
  ...
  //     setPannaAdded([]);
  //   } else {
  //     updatedPannaAdded(doublePanna0);
  //     updatedPannaAdded(doublePanna1);
  //     updatedPannaAdded(doublePanna2);
  //     updatedPannaAdded(doublePanna3);
  //     updatedPannaAdded(doublePanna4);
  //     updatedPannaAdded(doublePanna5);
  //     updatedPannaAdded(doublePanna6);
  //     updatedPannaAdded(doublePanna7);
  //     updatedPannaAdded(doublePanna8);
  //     updatedPannaAdded(doublePanna9);
  //   }
  // }, [digit]);
  useEffect(() => {
    if (digit.length < 4) {
