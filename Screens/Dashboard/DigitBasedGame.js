      ...
      <View style={styles.topviewContainer}>
        {true && (
          ...
          >
            ...
            <TextField
              style={{ width: 120, color: constant.Colors.primary }}
              returnKeyType={constant.ReturnKeyType.next}
              required={true}
      ...
      <View style={styles.topviewContainer}>
        {true && (
          <View style={{ flexDirection: "row" }}>
            <CheckBox value={isSPSelected} onValueChange={setSPSelection} />
            <Text style={styles.evenadd}>{"SP"}</Text>
          </View>
        )}
        {true && (
          <View style={{ flexDirection: "row" }}>
            <CheckBox value={isDPSelected} onValueChange={setDPSelection} />
